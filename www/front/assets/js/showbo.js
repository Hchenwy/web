...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="right_showbo"><div class="title_showbo" id="dvMsgTitle"></div></div></div>'+
        '<div class="body"><div class="right_showbo"><div class="ct" id="dvMsgCT"></div></div></div>'+
        '<div class="bottom" id="dvMsgBottom"><div class="right_showbo"><div id="dvMsgBtns"></div></div></div>';
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.type="button";  
        btn.className='btn_showbo';
        btn.value=v;  
        btn.onmouseover=function(){this.className='btnfocus';}  
        btn.onmouseout=function(){this.className='btn_showbo';}
    ...
    alert:function(msg,fn){
      this.show({buttons:{yes:'确认'},msg:msg,fn:fn});
    },  
    ...
    onResize:function(isResize){  
       ...
       Showbo.Msg.dvMsgBox.style.top=50+'px';
